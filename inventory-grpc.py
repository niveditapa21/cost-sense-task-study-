...
def main():
    ...
    # Demo REST API
    rest_product_id = demo_rest_api()
    
    time.sleep(1)  # Brief pause between demos
    
    # Demo gRPC API
    grpc_product_id = demo_grpc_api()
    ...
    print("✅ REST API Demo - Product created and managed")
    print("✅ gRPC API Demo - Product created and managed") 
    print("✅ Stock Management - IN/OUT transactions working")
    print("✅ QuestDB Integration - All data stored successfully")
    print("✅ Time-series Data - Transaction history tracked")
    
    if rest_product_id:
        print(f"\n📦 REST Product ID: {rest_product_id}")
    if grpc_product_id:
        print(f"📦 gRPC Product ID: {grpc_product_id}")
    
    print("\n🎉 Inventory Management System is fully functional!")
    print("Both REST and gRPC APIs are working with QuestDB backend.")
